<template>
    <nav class="top-bar">
        <div class="float-content" :style="floatBtnStyle">
            ...
            <circle-icon-button class="button tips tips-left tips-down" :title-content="string.closeJMEHunter" icon="close" @click="closeJMEHunter"></circle-icon-button>
        </div>
        <div :class="['inner-content', { hide: !showTopBar, 'more-settings': showMoreSettings }]" :style="topBarStyle">
            <template v-if="readSettings">
                ...
                <div class="item">
                    <a class="label icon tips tips-down clickable" :title-content="string.githubTip" target="_blank" href="https://github.com/hanFengSan/JM-EHunter">
...
export default {
    ...
    methods: {
        ...
        closeJMEHunter() {
            SettingService.toggleJMEHunter(false);
            this.service.JM-EHunter.showJM-EHunterView(false);
        },
